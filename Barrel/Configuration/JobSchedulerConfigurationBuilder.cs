...
public class JobSchedulerConfigurationBuilder
{
    ...
    public JobSchedulerConfigurationBuilder WithMaxConcurrentJobs(int maxConcurrentJobs)
    {
        if (maxConcurrentJobs < 1)
            throw new ArgumentOutOfRangeException($"{nameof(MaxConcurrentJobs)} property must be greater than zero");
    ...
    {
        if (milliseconds < 0)
            throw new ArgumentOutOfRangeException($"{nameof(QueuePollingRate)} property must be positive");
    ...
    {
        if (milliseconds < 0)
            throw new ArgumentOutOfRangeException($"{nameof(SchedulePollingRate)} property must be positive");
